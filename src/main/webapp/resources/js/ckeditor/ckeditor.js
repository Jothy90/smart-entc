...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var b = {timestamp: "D08E", version: "4.0.1", revision: "d02739be4b", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
            ...
            -1 == a.indexOf(":/") && (a = 0 === a.indexOf("index-2.html") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] + a : location.href.match(/^[^\?]*\/(?:)/)[0] +
                a);
            ...
            -1 == a.indexOf(":/") && 0 !== a.indexOf("index-2.html") && (a = this.basePath + a);
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        var b = navigator.userAgent.toLowerCase(), c = window.opera, a = {ie: eval("/*@cc_on!@*/false"), opera: !!c && c.version, webkit: b.indexOf("applewebkit/index.html") > -1, air: b.indexOf("adobeair/index.html") > -1, mac: b.indexOf("macintosh") > -1, quirks: document.compatMode == "BackCompat", mobile: b.indexOf("mobile") > -1, iOS: /(ipad|iphone|ipod)/.test(b), isCustomDomain: function () {
            ...
            for (var f, e, d = 0, g; f = this._.htmlPartsRegex.exec(a);) {
                ...
                if (g)g.push(f[0]); else if (e = f[3]) {
                    ...
                    if (!/="/.test(e)) {
                        var k = {}, h;
                        f = f[4];
                        var m = !!(f && f.charAt(f.length - 1) == "index-2.html");
                        if (f)for (; h = b.exec(f);) {
    ...
    CKEDITOR.editor.prototype.getStylesSet = function (b) {
        if (this._.stylesDefinitions)b(this._.stylesDefinitions); else {
            ...
            if (a instanceof Array) {
                ...
                var a = a.split(":"), f = a[0];
                CKEDITOR.stylesSet.addExternal(f, a[1] ? a.slice(1).join(":") : CKEDITOR.getUrl("styles.html"), "");
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {popup: function (e, a, b, d) {
        ...
        if (!c)return!1;
        try {
            -1 == navigator.userAgent.toLowerCase().indexOf("chrome/index.html") && (c.moveTo(g, f), c.resizeTo(a, b)), c.focus(), c.location.href = e
        } catch (h) {
